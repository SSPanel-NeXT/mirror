...
Group:          Unspecified
License:        GPL-3.0
URL:            https://github.com/SSPanel-UIM/NetStatus-API-Go
...
install -m 755 %{_builddir}/%{name}-%{version}/netstatus-api-go-arm64-linux %{buildroot}/usr/local/netstatus-api-go/netstatus-api-go
...
%changelog
* Sun Dec 23 2023 SSPanel-UIM Team <package@sspanel.org> - 0.0.1-1
 - https://github.com/SSPanel-UIM/NetStatus-API-Go/releases/tag/v0.0.1
